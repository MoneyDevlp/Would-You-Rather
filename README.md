...
- Get project, run `git clone https://github.com/MoneyDevlp/Would-You-Rather.git` in git bash or terminate

-  Install dependencies run `npm install/yarn add`

-  Start project run `npm/yarn start`
